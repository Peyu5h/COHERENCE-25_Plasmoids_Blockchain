...
export default function AuthorityDashboard() {
  ...
  const [activeCertTab, setActiveCertTab] = useState("pending");
  ...
  const loadCertificates = async () => {
    ...
    try {
      ...
      if (verifiedResponse.data?.success) {
        setVerifiedCertificates(verifiedResponse.data.data || []);
      } else {
        //mockdata for now
      ...
      const allCertificates = [...pendingCertificates, ...verifiedCertificates];
      const users = [
      ...
      <div className="container mx-auto max-w-4xl p-8">
        ...
        >
          ...
          <TabsContent value="certificates">
            <Tabs value={activeCertTab} onValueChange={setActiveCertTab}>
              <TabsList className="mb-6">
                    ...
                    <CardContent className="py-10">
                      <div className="text-center">
                        ...
                        <p className="text-gray-500">
                          You have no certificate requests waiting for
                          verification
                        </p>
                      </div>
                    </CardContent>
